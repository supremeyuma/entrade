<section class="blockElement space bg-gray-100 dark:bg-gray-800">
    <div class="container">
        <div class="row justify-center text-center">
            <div class="col-12 col-xl-10">
                ...
                <div class="mt-12 text-center">
                    <p class="text-gray-700 dark:text-gray-300">
                        Don’t see the right fit? <a href="#" class="text-primary font-semibold hover:underline">Send us your CV</a> – we’re always hiring!
                    </p>
                </div>
            </div>
        </div>
