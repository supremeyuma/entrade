<x-layouts.guest>
    <div class="max-w-4xl mx-auto py-12 px-6 text-gray-800 dark:text-gray-200">
        ...
        <p class="mb-4">
            Forex, crypto, and stock markets are inherently volatile. Events such as economic shifts, regulation changes, and market sentiment can significantly affect trade outcomes.
        </p>
        ...
        <p class="mb-4">
            Even verified traders can have losing trades. All investments carry the possibility of loss, including total loss of allocated funds.
        </p>
