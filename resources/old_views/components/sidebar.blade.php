...
>
    ...
    <nav class="px-4 py-6 space-y-2 text-gray-700 dark:text-gray-300" x-data="{ userMenuOpen: false, adminMenuOpen: false }">
        ...
        @if($user && $user->hasRole('user'))
            ...
            <div>
                <button @click="userMenuOpen = !userMenuOpen" class="flex items-center justify-between w-full px-3 py-2 rounded hover:bg-indigo-100 dark:hover:bg-indigo-700">
                    ...
                    <svg :class="{ 'rotate-180': userMenuOpen }" class="w-4 h-4 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
